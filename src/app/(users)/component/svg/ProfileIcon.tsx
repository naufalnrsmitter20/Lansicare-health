        ...
        >
          <g filter="url(#filter0_d_627_1060)">
            <path
              ...
              className={`${UsePathnames === "/profile" ? "fill-Navbar-Hover" : "fill-base-100"} fill-base-100 group-hover:fill-Navbar-Hover`}
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
