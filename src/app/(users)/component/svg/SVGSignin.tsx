      ...
      >
        ...
        >
          <path
            ...
            className={`${UsePathnames === "/signin" ? "fill-Navbar-Hover" : "fill-base-100"} group-hover:fill-Navbar-Hover`}
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
