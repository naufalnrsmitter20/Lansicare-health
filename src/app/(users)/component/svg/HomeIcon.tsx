  ...
  return (
    <div>
      ...
      >
        <svg
          width="18"
          className="group block h-5 w-5 flex-shrink-0 transition duration-75  lg:mx-auto"
          height="19"
          viewBox="0 0 15 16"
          fill="none"
        ...
        >
          <path
            ...
            className={`${UsePathnames === "/homepage" ? "fill-Navbar-Hover" : "fill-base-100"} fill-base-100 group-hover:fill-Navbar-Hover`}
          />
        </svg>
        <p
          className={`${UsePathnames === "/homepage" ? "text-darkBlue" : "text-base-100"} rounded px-2 text-[12px] font-semibold text-base-100 hover:bg-gray-100 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:p-0 md:hover:bg-transparent group-hover:md:text-Navbar-Hover md:dark:hover:bg-transparent group-hover:md:dark:text-Navbar-Hover`}
        >
          Home
        </p>
      </Link>
