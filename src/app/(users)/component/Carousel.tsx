              ...
              >
                ...
                <div className="max-w-sm px-4 py-24 text-start lg:max-w-screen-xl lg:py-20">
                  ...
                  <p className="mb-8 text-sm font-normal text-gray-300 sm:px-16 lg:px-48 lg:text-lg">
                    ...
                    riwayat check-up kesehatan. Dapatkan akses informasi
                    kesehatan Anda dengan mudah dan cepat. Kami berkomitmen
                    untuk menyediakan layanan yang dapat meningkatkan kesehatan
              ...
              >
                ...
                <div className=" max-w-screen-xl px-4 py-24 text-end lg:mr-40 lg:py-20">
                  ...
                  <p className="mb-8 text-end text-sm font-normal text-gray-300 sm:pl-16 lg:pl-64 lg:text-lg">
                    ...
                    keluar nomor antrean dan waktu untuk pemeriksaan. Selain
                    itu, website ini juga membantu Anda untuk mengecek riwayat
                    pemeriksaan Anda. Anda tidak perlu lagi mengantre dengan
                    kurun waktu yang lama di klinik karena bisa mengantre secara
