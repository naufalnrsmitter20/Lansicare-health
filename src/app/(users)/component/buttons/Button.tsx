...
const ButtonProops: CustomFlowbiteTheme = {
  button: {
    color: {
      ...
      carousel:
        "flex w-40 items-center justify-center rounded-lg bg-darkBlue text-center text-xs font-medium text-white hover:bg-mainBlue focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900 md:text-sm lg:w-auto lg:text-base transition-all duration-300",
      loading:
